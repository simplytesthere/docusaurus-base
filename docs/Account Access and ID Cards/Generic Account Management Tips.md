...
If the generic account's email must be checked by several people at any point, we recommend setting up email delegation. This way, multiple people can check the account without interacting with MFA. 
